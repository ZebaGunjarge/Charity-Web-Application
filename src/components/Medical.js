                ...
                <div class="row">
                    ...
                    <div class="row-lg-6  row-md-9   wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box">
                            ...
                            <div class="modal fade" id="modalMedicalForm" tabindex="-1" role="dialog"
                                aria-labelledby="myModalLabel" aria-hidden="true" method="post" name="modalNaturalForm">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title w-100 font-weight-bold"> Medical</h4>
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <input ref="DonationCateogry" type="text" name="DonationCateogry" id="Form1-dc"
                                                ...
                                                <label data-error="wrong" data-success="right"
                                                    for="defaultForm-Lname">Category (e.g. Day Care Clinic, Blood Donation, First-Aid Items, Medical Equipments etc)</label>
                            ...
                            <div class="text-center">
                                <a href="#modalMedicalForm" class="btn btn-default btn-rounded mb-4" data-toggle="modal"
                                    data-target="#modalMedicalForm">
                                    <h4> Medical</h4>
                                </a>
                            </div>
