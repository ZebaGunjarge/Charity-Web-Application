                ...
                <div class="row">
                    ...
                    <div class="row-lg-6  row-md-9 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box">
                            ...
                            <div class="modal fade" id="modalAnimalForm" tabindex="-1" role="dialog"
                                aria-labelledby="myModalLabel" aria-hidden="true" method="post" name="modalNaturalForm">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title w-100 font-weight-bold"> Animal</h4>
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <input ref="DonationCateogry" type="text" name="DonationCateogry" id="Form1-dc"
                                                ...
                                                <label data-error="wrong" data-success="right"
                                                    for="defaultForm-Lname">Category (e.g. Adaption, Shelter, Conservation, veterinary care etc)</label>
                            ...
                            <div class="text-center">
                                <a href="#modalAnimalForm" class="btn btn-default btn-rounded mb-4" data-toggle="modal"
                                    data-target="#modalAnimalForm">
                                    <h4>Animal</h4>
                                </a>
                            </div>
                            <p class="description">An astonishing 60% decline in the size of populations of mammals,
                                    birds, fish, reptiles, and amphibians in just over 40 years, according to WWF's
                                    Living Planet Report 2018. This is a very troubling stat; The animals are
                                    getting endagered day-by-day. Please help us in conserving animal life.
                            </p>
